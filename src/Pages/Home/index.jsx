		...
		<>
			...
			<section className="section-light-home">
				...
				<article className='text-center flex flex-col items-center space-y-6 xl:w-1/2'>
					...
					<p className='text-white text-lg leading-relaxed'>Meu nome é Mauricio, sou natural de Parnaíba-PI. Tenho formação técnica em Administração, Atendimento ao Cliente e Gestão de Pessoas. Estou me desenvolvendo na área de Tecnologia com foco em backend e busco trabalhar com programação. Possuo experiência com Bancos de Dados SQL (MYSQL e Firebird), linguagem Javascript, Typescript, React Js para desenvolvimento Frontend com diversas ferramentas adicionais, NodeJs para desenvolvimento Backend com diversas ferramentas adicionais. Finalizei meus estudos básicos na <a className='underline' target='_blank' href="http://devmedia.com/" rel="noreferrer">DevMedia</a>, e estou estudando conhecimentos mais avançados na <a className='underline' target='_blank' href="https://www.rocketseat.com.br/" rel="noreferrer">RocketSeat</a>, duas das maiores escolas de programação do mercado.</p>
				</article>
			</section>
			<FloatButton />
			<Footer />
