...
export default function Home() {
    ...
    return (
        <div>
            <Header />
            <section className="bg-light-blue-project flex flex-col fundo-home px-5 space-y-5 lg:flex-row lg:justify-around xl:flex-row xl:justify-around 2xl:flex-row 2xl:justify-around">
